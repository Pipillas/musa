            ...
            window.JSPM.JSPrintManager.WS.onStatusChanged = function () {
                if (jspmWSStatus()) {
                    window.JSPM.JSPrintManager.getPrinters().then(function (myPrinters) {
                        ...
                        const godexPrinter = myPrinters.find(printer => printer === 'Godex GE300');
                        if (godexPrinter) {
            ...
            <div className="formulario-container">
                <form onSubmit={handleSubmit} onKeyDown={handleKeyDown} className="formulario">
                    ...
                    <div className="form-group">
                        ...
                        <NumericFormat prefix='$' value={formData.venta} thousandSeparator="." decimalSeparator=',' onValueChange={(e) => handleChangeNumber(e.floatValue)} />
                    </div>
                    <div className="form-group">
                        ...
                        <tbody>
                            {productos?.map((producto) => (
                                <tr key={producto._id}>
                                    ...
                                    <td onClick={() => deleteProducto(producto)} className="editar"><i className="bi bi-trash3-fill"></i></td>
                                </tr>
                            ))}
                        </tbody>
                    </table>
