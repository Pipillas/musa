...
function Info() {
    ...
    const fetchProductos = (page, search, isCarrito, isFavorito, ordenadoCantidad) =>
    ...
    useEffect(() => {
        socket.on("cambios", () => {
            ...
            fetchProductos(page, search, isCarrito, isFavorito, ordenadoCantidad, ordenadoCepa);
        });
    ...
    }, [page, search, producto, showModal, isCarrito, isFavorito, ordenadoCantidad, ordenadoCepa]);
        ...
        <div className="tabla-container-info">
            <div className="buscador">
                ...
                <div className="buscar-favorito">
                    ...
                    <button
                        className={`toggle-carrito toggle-button ${isCarrito ? "active" : ""
                            }`}
                ...
                <table>
                    <thead>
                        <tr className="titulos-tabla">
                            ...
                            >
                                Cantidad {ordenadoCantidad && <i className="bi bi-arrow-bar-down"></i>}
                            </th>
                            <th>Foto</th>
                            <th></th>
                            <th></th>
