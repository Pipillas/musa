...
function Info() {
  ...
  const fetchProductos = (page, search, isCarrito, isFavorito, ordenado) =>
  ...
  useEffect(() => {
    socket.on("cambios", () => {
      ...
      fetchProductos(page, search, isCarrito, isFavorito, ordenado);
    });
  ...
  }, [page, search, producto, showModal, isCarrito, isFavorito, ordenado]);
          ...
          <thead>
            <tr className="titulos-tabla">
              ...
              <th
                ...
                onClick={() => setOrdenado((prev) => !prev)}
              >
                Cantidad {ordenado && <i className="bi bi-arrow-bar-down"></i>}
              </th>
              <th>Foto</th>
              <th></th>
              <th></th>
